    ...
    <div class="container-floor-select">
        <div id="floor-selection-form" class="floor-selection">
            ...
            ?>
                ...
                <div class="container1">
                    <div class="card p-3">
                                ...
                                <tbody>
                                    <?php foreach ($booked_rooms as $room): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <form method="POST" action="release_room.php" class="d-inline">
                        ...
                        <?php else: ?>
                            <div class="alert alert-info">You have no rooms booked at the moment.</div>
                        <?php endif; ?>
                    </div>
                </div>
            <?php
            } elseif ($user['building'] == 4) {
            ?>
                <h1>Parking Building 4</h1>
                <br>
                <h5>Select The Floor</h5>
                <p><span style="font-size:10.0pt">(Click On The Floor to Find Available Parking)</span></p>
                <br>
                <div class="floor-buttons">
                    <button type="button" class="floor-btn" data-step="0">Ground</button>
                    <button type="button" class="floor-btn" data-step="1">1st</button>
                    <button type="button" class="floor-btn" data-step="2">2nd</button>
                </div>
                <div class="form-step">
                    <h2>Ground Floor</h2><br>
                    <div class="slots">
            ...
            <?php
                ...
                echo ('<h2>No parking building is selected *_* .</h2><br>
            <p>(You can choice parking building in <strong>"Menu > Change Building"</strong>)</p>');
            }
            ?>
        </div>
    </div>
            ...
            fetch('fetch_parking_status.php')
                ...
                .then(data => {
                    ...
                    for (const floor of sortedFloors) {
                        const availableSpots = floors[floor].filter(p => p.status_light == 0);
